                    ...
                    if input_pin == account['pin']:
                        ...
                        if choice == 1:
                            ...
                            while (True):
                                ...
                                withdraw_input = input("Enter the amount you wish to withdraw or press (6) to go back to the previous menu: ")
                                        ...
                                        if confirm in ('Y', 'y'):
                                            ...
                                            with open("account.txt", "w") as f:
                                                for _account in accounts:
                                                    _str = str(_account['pin']) + ', ' + str(
                                                        _account['balance']) + ', ' + _account['name'] + '\n'
                                                    f.write(_str)
                                            break
                                        else:
                            ...
                            if deposit_input.lower() == '6':
                                ...
                                if confirm in ('Y', 'y'):
                                    ...
                                    with open("account.txt", "w") as f:
                                        for _account in accounts:
                                            _str = str(_account['pin']) + ', ' + str(_account['balance']) + ', ' + \
                                                   _account['name'] + '\n'
                                            f.write(_str)
                                else:
                                    print("Cancelling transaction...")
                                ...
                                if confirm in ('Y', 'y'):
                                    ...
                                    with open("account.txt", "w") as f:
                                        for account_ in accounts:
                                            _str = str(account_['pin']) + ', ' + str(account_['balance']) + ', ' + \
                                                   account_['name'] + '\n'
                                            f.write(_str)
                                else:
                                    print("Cancelling transaction...")
